...
class DashboardController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        return view('dosenKoordinator.dashboard.index')->with(compact('absens','thnAkademiks','thnAkademikSekarang'));
    }
    ...
    public function showListAbsensiKelas($id)
    {
        ...
        return view('dosenKoordinator.dashboard.showListAbsensiKelas')->with(compact('absens','kelas'));
    }
}
