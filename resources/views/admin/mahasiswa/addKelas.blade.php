...
<section class="section">
    <div class="section-header">
        <h1>Data Kelas {{ $mahasiswa->nama_mahasiswa }}</h1>
    </div>
    ...
    <div style="width: 100%;">
        <a style="float: left;" href="/admin/mahasiswa"><button class="btn btn-success"><i class="fas fa-reply"></i> Kembali</button></a>
    </div>
    <br><br><br>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Data Mata Kuliah Mahasiswa (Tahun Akademik {{ $thnAkademikSekarang->thn_akademik_1 }}/{{ $thnAkademikSekarang->thn_akademik_2 }} - Semester {{ $thnAkademikSekarang->semester }})</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ action('admin\DetKelasController@store') }}">
                            @csrf
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Tabel Data Mata Kuliah Mahasiswa </h4>
                        <div class="card-header-action">
                            <div class="form-group" style="margin: 0;">
                                <script>
                                    function thnAkademikRefresh(){
                                        var id_thn_akademik = document.getElementById("idThnAkademik").value;
                                        var id_mahasiswa = document.getElementById("idMahasiswa").value;
                                        $.ajax({
                                            type: "get",
                                            url: "/admin/detail-kelas/detail-kelas/refresh",
                                            dataType: 'json',
                                            data: {"id_thn_akademik" : id_thn_akademik, "id_mahasiswa" : id_mahasiswa}, // serializes the form's elements.
                                                ...
                                                $.each(msg, function(i,obj){
                                                    ...
                                                    div += '<tr>' +
                                                            ...
                                                            '<td style="vertical-align: middle;">' +
                                                                '<a class="btn btn-danger" href="/admin/mata-kuliah/' + msg[i].id_det_kelas + '/delete" onclick="return confirm(`Apakah anda yakin ingin menghapus?`)"><i class="fas fa-trash"></i></a>' +
                                                            '</td>' +
                                                            '</tr>';
                                                });
                                ...
                                <input type="hidden" id="idMahasiswa" value="{{ $mahasiswa->id_mahasiswa }}">
                            </div> 
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($kelass as $key => $kelas)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <a class="btn btn-danger" href="/admin/mata-kuliah/{{ $kelas->id_det_kelas }}/delete" onclick="return confirm('Apakah anda yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
