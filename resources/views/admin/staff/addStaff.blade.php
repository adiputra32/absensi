        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ action('admin\StaffController@store') }}">
                            @csrf
                            <h5>Data Staff</h5>
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_staff" placeholder="Nama Staff" value="{{ old('nama_staff') }}" required>
                                </div>
                            </div>
