        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ action('admin\ProdiController@update', $prodi->id_prodi) }}">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-group row">
                                <div class="col-form-label col-sm-2">Program Studi</div>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="prodi" placeholder="Program Studi" value="{{ $prodi->prodi }}" required>
                                </div>
                            </div>
