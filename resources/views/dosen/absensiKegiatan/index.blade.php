                                  ...
                                  @foreach($absens as $key => $absen)
                                      ...
                                      <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                ...
                                                <form method="POST" action="{{ action('dosen\AbsensiKegiatanController@absen', $absen->id_det_absensi_kegiatan) }}">
                                                    ...
                                                    <select class="form-control" name="absensi" onchange="this.form.submit();" required>
                                                        ...
                                                        <option value="Dinas Luar" selected>Dinas Luar</
                                                        
                                                        <option value="WFH">WFH</option>option>
