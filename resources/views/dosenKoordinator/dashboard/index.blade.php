                                  ...
                                  @foreach($absens as $key => $absen)
                                      <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <a class="btn btn-info" title="Lihat" href="dashboard/{{ $absen->id_kelas }}"><i class="fas fa-eye"></i></a>    
                                            </td>
                                      </tr>
                                  @endforeach
                              </tbody>
            ...
            success: function (msg, status, jqXHR){
                ...
                $.each(msg, function(i,obj){
                    ...
                    div += '<tr>' +
                            ...
                            '<td style="vertical-align: middle;">' +
                                '<a class="btn btn-info" title="Lihat" href="dashboard/' + msg[i].id_kelas + '"><i class="fas fa-eye"></i></a>' +
                            '</td>' +
                            '</tr>';
                });
