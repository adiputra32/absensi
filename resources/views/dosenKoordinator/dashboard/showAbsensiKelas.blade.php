        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ action('dosenKoordinator\AbsensiKelasController@updateMateriMetode', $id) }}" method="POST">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-group row">
                                <div class="col-form-label col-sm-3">Dosen Pengampu/Materi</div>
                                <div class="col-sm-9">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                @if($kelas->status == "Aktif")
                                                    ...
                                                    <form method="POST" action="{{ action('dosenKoordinator\AbsensiKelasController@absenDosen', $absenDosen->id_det_absensi_kelas_dosen) }}">
                                                        @csrf
                                                        {{ method_field('PATCH') }}
