  ...
  <div class="card-body">
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="form-group">
        ...
        <input id="username" type="username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="Username address" name="username" tabindex="1" value="{{ old('username') }}" autofocus>
        <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid': '' }}" placeholder="Set account password (min. 8 character)" name="password" tabindex="2">
        <div class="invalid-feedback">
